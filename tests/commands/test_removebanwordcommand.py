...
class TestRemoveBanCommand(unittest.TestCase):
	...
	def test_execute__remove_ban_word_valid(self, word_patch):
	...
	def test_execute__remove_ban_non_banned_word(self, word_patch):
		time = datetime.datetime.now()
		server_json = {
			'server_id' : 1,
			'awake' : True,
      ...
      'author': Mock(**{
		...
		self.assertEqual(result, "Sorry, I couldn't find a matching word to unban.")
